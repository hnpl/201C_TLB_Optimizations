...
static TElement max_error_a = 0.0;
static TElement min_error_a = 0.0;
static int error_count_b = 0;
static TElement max_error_b = 0.0;
static TElement min_error_b = 0.0;
static int error_count_c = 0;
static TElement max_error_c = 0.0;
static TElement min_error_c = 0.0;
